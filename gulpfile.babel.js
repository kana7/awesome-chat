...
function outputWebpack(label, error, stats) { //define console output for the console
    if (error) { //webpack-settings error
        throw new Error(error);
    }
    //
    if (stats.hasErrors()) { //coding error
